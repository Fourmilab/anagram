...
dvipdfm cob\cr
acroread cob.pdf\cr}}$$
instead of invoking \TeX\ in the normal way. (Thanks to Hans Hagen and
C\'esar Augusto Rorato Crusius for the macros that make this work.)
...
$$\lpile{\.{\\ZZ \{Introduction\}\{0\}\{1\}\{26\}}\cr
  \.{\\ZZ \{The character set\}\{2\}\{5\}\{27\}}\cr}$$
...
or visit \\pdfURL\{his home page\}\{http://www.pobox.com/%
       \\TILDE/scherer\}.\cr}}$$
In a PDF document, the first argument will appear in blue as
